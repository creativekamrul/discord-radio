...
export const api = {
  ...
  navidromePlaySong: (guildId, songId) => request('POST', `/navidrome/play/${guildId}/${songId}`),
  navidromeEnqueueSong: (guildId, songId) => request('POST', `/navidrome/enqueue/${guildId}/${songId}`),
